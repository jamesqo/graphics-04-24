...
def scanline_convert(polygons, i, screen, zbuffer, color ):
    x1, x2, x3 = polygons[i][0], polygons[i+1][0], polygons[i+2][0]
    y1, y2, y3 = polygons[i][1], polygons[i+1][1], polygons[i+2][1]
    z1, z2, z3 = polygons[i][2], polygons[i+1][2], polygons[i+2][2]

    assert len(set([x1, x2, x3])) != 1 and len(set([y1, y2, y3])) != 1, "Degenerate triangle"
